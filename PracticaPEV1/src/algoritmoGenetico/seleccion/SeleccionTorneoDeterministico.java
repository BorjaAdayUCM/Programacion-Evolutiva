...
public class SeleccionTorneoDeterministico extends Seleccion {
	...
	public SeleccionTorneoDeterministico(double[] fitness, Individuo[] poblacion, int tamPoblacion, Random rand, int tamTorneo, double escogerMejor, double umbralTruncamiento, int numProblema) {
	...
	public Individuo[] run() {
		...
		for(int i = 0; i < this.tamPoblacion; i++) {
			...
			switch(this.numProblema) {
				case 1: poblacionFinal[i] = new IndividuoFuncion1(torneo[mejor]); break;
				case 2: poblacionFinal[i] = new IndividuoFuncion2(torneo[mejor]); break;
				case 3: poblacionFinal[i] = new IndividuoFuncion3(torneo[mejor]); break;
				case 4: poblacionFinal[i] = new IndividuoFuncion4((IndividuoFuncion4) torneo[mejor]); break;
				case 5: poblacionFinal[i] = new IndividuoFuncion5((IndividuoFuncion5) torneo[mejor]); break;
			}
		}
