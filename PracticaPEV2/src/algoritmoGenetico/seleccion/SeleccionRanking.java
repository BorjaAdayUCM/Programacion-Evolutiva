...
public class SeleccionRanking extends Seleccion {
	...
	public SeleccionRanking(double[] fitness, Individuo[] poblacion, int tamPoblacion, Random rand, int tamTorneo, double escogerMejor, double umbralTruncamiento, int numProblema) {
	...
	public Individuo[] run() {
		...
		poblacionFinal = new SeleccionRuleta(fitnessRanking, this.poblacion, this.tamPoblacion, this.rand,this.tamTorneo, this.escogerMejor, this.umbralTruncamiento, this.numProblema).run();
